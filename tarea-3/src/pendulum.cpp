...
int main() {
  ...
  save("pendulum_theta_fd.png");

  // === FIGURA 2: θ(t) con y sin reinicio para F_D = 1.2 ===
  double F_D = 1.2;
  auto f2 = figure(false);
  hold(on);
  ...
  save("pendulum_theta_comparison.png");

  // === FIGURA 3: ω(t) para F_D = 1.2 ===
  auto f3 = figure(false);
  hold(on);
  ...
  save("pendulum_omega.png");

  std::cout << "✅ Gráficas guardadas como:\n"
            << " - pendulum_theta_fd.png\n"
            << " - pendulum_theta_comparison.png\n"
            << " - pendulum_omega.png\n";
