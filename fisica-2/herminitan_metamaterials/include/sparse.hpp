...
// Number of degrees of freedom per field component on an N×N grid.
inline Int dof_per_field(Int N) noexcept { return N * N; }

// Row/column offset of block b when each block has dof_per_field(N) entries.
inline Int block_offset(Int b, Int N) noexcept { return b * dof_per_field(N); }
